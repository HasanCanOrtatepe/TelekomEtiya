...
import com.etiya.etiyatelekom.business.abst.*;
...
public class TicketServiceImpl implements TicketService {
    ...
    public TicketResponse getById(Long id) {
        ...
        TicketResponse response = modelMapperService.forResponse().map(ticket, TicketResponse.class);
        if (response.getComplaintId() == null && ticket.getComplaint() != null) {
            response.setComplaintId(ticket.getComplaint().getId());
        }
        return response;
    }
    ...
    private Ticket changeStatus(Ticket ticket, TicketStatusEnums toStatus) {
        ...
        if (toStatus == TicketStatusEnums.CLOSED && ticket.getClosedAt() == null) {
            ...
            if (ticket.getComplaint() != null) {
                ticket.getComplaint().setIsActive(false);
                if (ticket.getComplaint().getAiAnalysis() != null) {
                    ticket.getComplaint().getAiAnalysis().setIsActive(false);
                }
            }
        }
